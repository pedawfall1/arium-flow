    ...
    <header className="fixed top-0 z-40 flex h-16 w-full items-center justify-between border-b bg-[#0D0618] px-4 md:px-6 border-zinc-800">
      <div className="flex items-center gap-4">
        ...
        <div className="md:hidden flex items-center gap-2">
          <Image src="/logo.png" alt="Arium Logo" width={32} height={32} className="rounded-lg object-contain" />
      ...
      <div className="flex items-center gap-4">
        ...
        <Link href="/configuracoes">
          <div className="h-8 w-8 rounded-full bg-purple-600/20 border border-purple-500/30 flex items-center justify-center text-purple-400 font-medium cursor-pointer hover:bg-purple-600/30 hover:border-purple-400/50 transition-all">
            AF
          </div>
        </Link>
      </div>
